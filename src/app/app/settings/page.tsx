  ...
  const handleResetData = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        await supabase.from("bodyweights").delete().eq("user_id", user.id);
  ...
  return (
    <div style={{ padding: "24px 16px 96px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                >
                  {user.user_metadata?.full_name || "Signed in Athlete"}
                </span>
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        >
          WorkoutSplit is still under active development. Features may change
          and you may hit the odd bug.
        </p>
      </div>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {[
                ...
                <button
                  key={t.id}
                  onClick={() =>
                    updateSettings({ theme: t.id as "light" | "dark" })
                  }
                  style={{
                    flex: 1,
                    padding: "12px",
                    ...
                    backgroundColor:
                      theme === t.id ? "#FFE100" : "var(--input-bg)",
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {["kg", "lbs"].map((unit) => (
                <button
                  key={unit}
                  onClick={() =>
                    updateSettings({ weightUnit: unit as "kg" | "lbs" })
                  }
                  style={{
                    flex: 1,
                    padding: "10px",
                    ...
                    border:
                      weightUnit === unit
                        ...
                        : "2px solid var(--border-light)",
                    backgroundColor:
                      weightUnit === unit ? "#FFE100" : "var(--input-bg)",
                    color:
                      weightUnit === unit ? "#111111" : "var(--text-primary)",
                    fontWeight: 800,
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12, color: "var(--text-secondary)" }}>
                Auto-countdown after completing a set
              </div>
            </div>
            <button
            ...
            >
              <div
                style={{
                  ...
                  height: 20,
                  borderRadius: "50%",
                  background: showRestTimer
                    ? "#111111"
                    : "var(--text-secondary)",
                  position: "absolute",
                  top: 2,
                  left: showRestTimer ? 24 : 2,
                  transition: "all 0.2s",
                }}
              />
            </button>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {[30, 60, 90, 120].map((duration) => (
                  <button
                    key={duration}
                    onClick={() =>
                      updateSettings({ restTimerDuration: duration })
                    }
                    style={{
                      flex: 1,
                      minWidth: "20%",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {showResetConfirm ? (
            ...
            >
              ...
              >
                This will delete all your workouts, splits and progress. Are you
                sure?
              </p>
              <div style={{ display: "flex", gap: 8 }}>
                <button
