...
export default function LandingPage() {
  ...
  useEffect(() => {
    setMounted(true);
    // If running as installed PWA, skip landing page
    const isStandalone =
      ...
      <section style={{ padding: '88px 0' }}>
        <div style={{ maxWidth: SECTION_WIDTH, margin: '0 auto', padding: `0 ${SECTION_PX}` }}>
          ...
          <StaggerGrid className="landing-features-grid">
            {[
              { icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="#6d8a0a"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm-1 7V3.5L18.5 9H13zM8 13h8v1.5H8V13zm0 3h8v1.5H8V16z"/></svg>, title: 'Log Workouts', desc: 'Sets, reps, weight — all tracked. Built-in rest timer keeps your pace.', color: '#C8F135' },
              { icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="#0a7a9a"><path d="M5 20h2V10H5v10zm6 0h2V4h-2v16zm6 0h2v-6h-2v6z"/></svg>, title: 'Track Progress', desc: 'Charts that show real strength gains over weeks and months.', color: '#B4F0FF' },
              { icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="#c74080"><path d="M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94A5.01 5.01 0 0 0 11 15.9V19H7v2h10v-2h-4v-3.1a5.01 5.01 0 0 0 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2zM5 8V7h2v3.82C5.84 10.4 5 9.3 5 8zm14 0c0 1.3-.84 2.4-2 2.82V7h2v1z"/></svg>, title: 'Personal Records', desc: 'Auto-detected PRs. Every new max is celebrated and saved.', color: '#FFB4C8' },
              { icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="#7a50c0"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm.5 11H7v-1.5h4V7h1.5v6z"/></svg>, title: 'Workout History', desc: 'Every session logged. Filter by week, month, or all time.', color: '#E4B4FF' },
              { icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="#c07a20"><path d="M15 1H9v2h6V1zm-4 13h2V8h-2v6zm8.03-6.61l1.42-1.42c-.43-.51-.9-.99-1.41-1.41l-1.42 1.42A8.962 8.962 0 0 0 12 4c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9c0-2.12-.74-4.07-1.97-5.61zM12 20c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z"/></svg>, title: 'Rest Timer', desc: 'Preset countdowns (30s–120s). Visual ring so you never guess.', color: '#FFD4A8' },
              { icon: <svg width={24} height={24} viewBox="0 0 24 24" fill="#6d8a0a"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z"/></svg>, title: 'Private by Design', desc: 'No account. No cloud. Everything stays on your device.', color: '#C8F135' },
            ].map((f) => (
              <div key={f.title} className="landing-feature-card">
                <div style={{
                  width: 48, height: 48, borderRadius: 14,
                  background: f.color + '25', display: 'flex', alignItems: 'center', justifyContent: 'center',
                  marginBottom: 16,
                }}>
                  {f.icon}
                </div>
